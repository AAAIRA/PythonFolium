...
folium.Marker(location=[-6.258081, 106.977855],popup='SMAN 3 BEKASI',icon=folium.Icon(icon='info-sign')).add_to(bekasi)
folium.Marker(location=[-6.213199, 106.983054],popup='SMAN 4 BEKASI',icon=folium.Icon(icon='info-sign')).add_to(bekasi)
folium.Marker(location=[-6.273914, 106.922450],popup='SMAN 5 BEKASI',icon=folium.Icon(icon='info-sign')).add_to(bekasi)
folium.Marker(location=[-6.281140, 106.973828],popup='SMAN 6 BEKASI',icon=folium.Icon(icon='info-sign')).add_to(bekasi)
...
folium.Marker(location=[-6.233254, 107.009026],popup='SMPN 1 BEKASI',icon=folium.Icon(icon='info-sign')).add_to(bekasi)
folium.Marker(location=[-6.255393, 107.004703],popup='SMPN 2 BEKASI',icon=folium.Icon(icon='info-sign')).add_to(bekasi)
folium.Marker(location=[-6.234657, 107.007459],popup='SMPN 3 BEKASI',icon=folium.Icon(icon='info-sign')).add_to(bekasi)
folium.Marker(location=[-6.233031, 106.979753],popup='SMPN 4 BEKASI',icon=folium.Icon(icon='info-sign')).add_to(bekasi)
folium.Marker(location=[-6.204778, 106.988090],popup='SMPN 5 BEKASI',icon=folium.Icon(icon='info-sign')).add_to(bekasi)
folium.Marker(location=[-6.282557, 106.912404],popup='SMPN 6 BEKASI',icon=folium.Icon(icon='info-sign')).add_to(bekasi)
folium.Marker(location=[-6.244397, 106.983054],popup='SMPN 7 BEKASI',icon=folium.Icon(icon='info-sign')).add_to(bekasi)
folium.Marker(location=[-6.298767, 106.988846],popup='SMPN 8 BEKASI',icon=folium.Icon(icon='info-sign')).add_to(bekasi)
folium.Marker(location=[-6.292222, 106.964639],popup='SMPN 9 BEKASI',icon=folium.Icon(icon='info-sign')).add_to(bekasi)
folium.Marker(location=[-6.316533, 107.009239],popup='SMPN 10 BEKASI',icon=folium.Icon(icon='info-sign')).add_to(bekasi)
...
folium.Marker(location=[-6.253456, 106.947833],popup='Jatibening',icon=folium.Icon(icon='info-sign')).add_to(bekasi)
folium.Marker(location=[-6.197753, 106.981235],popup='Jalan Raya Kaliabang',icon=folium.Icon(icon='info-sign')).add_to(bekasi)
folium.Marker(location=[-6.254819, 106.986519],popup='Pekayon Jaya',icon=folium.Icon(icon='info-sign')).add_to(bekasi)
folium.Marker(location=[-6.274262, 106.971290],popup='Jaka Setia',icon=folium.Icon(icon='info-sign')).add_to(bekasi)
folium.Marker(location=[-6.286243, 107.030689],popup='Columbus Water Park',icon=folium.Icon(icon='info-sign')).add_to(bekasi)
folium.Marker(location=[-6.313719, 106.984065],popup='Bantar Gebang',icon=folium.Icon(icon='info-sign')).add_to(bekasi)
folium.Marker(location=[-6.343130, 106.970135],popup='Jalan Raja Wali 5',icon=folium.Icon(icon='info-sign')).add_to(bekasi)
folium.Marker(location=[-6.348079, 106.977497],popup='Ciketing Udik',icon=folium.Icon(icon='info-sign')).add_to(bekasi)
folium.Marker(location=[-6.218388, 106.966639],popup='Jalan Harapan Baru Timur',icon=folium.Icon(icon='info-sign')).add_to(bekasi)
folium.Marker(location=[-6.210604, 106.955108],popup='16',icon=folium.Icon(icon='info-sign')).add_to(bekasi)

folium.Marker(location=[-6.2077593, 107.0182006],popup='Super Indo Kaliabang',icon=folium.Icon(icon='info-sign')).add_to(bekasi)
folium.Marker(location=[-6.2059131, 107.0154498],popup='BSI Convention Center',icon=folium.Icon(icon='info-sign')).add_to(bekasi)
folium.Marker(location=[-6.2071796, 107.0183116],popup='Golden City Bekasi',icon=folium.Icon(icon='info-sign')).add_to(bekasi)
folium.Marker(location=[-6.2066899, 107.0212861],popup='Watras Gayeng',icon=folium.Icon(icon='info-sign')).add_to(bekasi)
folium.Marker(location=[-6.2084156, 107.0233471],popup='Rm. Bungo Jambak',icon=folium.Icon(icon='info-sign')).add_to(bekasi)
folium.Marker(location=[-6.2087737, 107.0206031],popup='Buun Koeffie',icon=folium.Icon(icon='info-sign')).add_to(bekasi)
folium.Marker(location=[-6.2078226, 107.0246099],popup='Toko Tian',icon=folium.Icon(icon='info-sign')).add_to(bekasi)
folium.Marker(location=[-6.2076484, 107.0231169],popup='Susu Kambing Etawa',icon=folium.Icon(icon='info-sign')).add_to(bekasi)
folium.Marker(location=[-6.2093547, 107.0222823],popup='Hobi Mainan',icon=folium.Icon(icon='info-sign')).add_to(bekasi)
folium.Marker(location=[-6.2099893, 107.0222835],popup='Bekasi Vapor Shop',icon=folium.Icon(icon='info-sign')).add_to(bekasi)
